"""
Django settings for mariner_app project.
"""
...
ETL_MODULE_LOCATIONS.append("mariner_app.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("mariner_app.search_components")
...
SECRET_KEY = "django-insecure-!#t*_2o+&570nuqxtdwd)hhu&ee8ciyp_m$^vbh2ojew&u_^=7"
...
ELASTICSEARCH_PREFIX = "mariner_app"

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'mariner_app.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "mariner_app",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "mariner_app.wsgi.application"
...
SESSION_COOKIE_NAME = "mariner_app"
...
# ES_MAPPING_MODIFIER_CLASSES = ["mariner_app.search.es_mapping_modifier.EsMappingModifier"]
